...
SHADOWSOCKS_SOURCES := redir.c \
	cache.c udprelay.c utils.c netutils.c json.c jconf.c \
	acl.c http.c tls.c rule.c \
	crypto.c aead.c stream.c base64.c \
	plugin.c ppbloom.c \
	android.c supppig.c tlog.c supdns.c

LOCAL_MODULE    := ss-redir
LOCAL_SRC_FILES := $(addprefix shadowsocks-libev/src/, $(SHADOWSOCKS_SOURCES))
LOCAL_CFLAGS    := -Wall -fno-strict-aliasing -DMODULE_REDIR \
